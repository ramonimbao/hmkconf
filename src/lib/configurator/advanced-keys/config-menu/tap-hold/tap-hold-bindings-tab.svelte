...
<script lang="ts">
  ...
  import { tapHoldConfigMenuStateContext } from "./context.svelte"
  ...
  const tapHoldConfigMenuState = tapHoldConfigMenuStateContext.get()
  const { binding } = $derived(tapHoldConfigMenuState)
</script>
